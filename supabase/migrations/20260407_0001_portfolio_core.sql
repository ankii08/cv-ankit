-- Ankit portfolio: Supabase base schema
-- Covers:
-- 1. Voice session rate limiting
-- 2. Optional vector/keyword document search tables for legacy ingestion scripts
-- 3. Hash storage for ingestion change detection
...
-- ---------------------------------------------------------------------------
-- Optional vector / keyword retrieval tables
-- Used by:
-- - scripts/ingest-rag.ts
-- - scripts/export-chunks.ts
-- - api/ops/rag-stats.js
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- Optional hash cache for ingestion
-- Used by scripts/ingest-rag.ts
-- ---------------------------------------------------------------------------
