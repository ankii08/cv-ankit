...
/**
 * Runner principal para la suite de evals del portfolio assistant
 *
 * Uso: npm run evals
 */
...
async function main() {
  ...
  console.log(`╔═══════════════════════════════════════════╗`)
  console.log(`║    Portfolio Assistant Evals Suite        ║`)
  console.log(`╚═══════════════════════════════════════════╝`)
  ...
  try {
    ...
    console.log(`${colors.dim}   2. Test against production: CHAT_API_URL=https://ankitd.com/api/chat npm run evals${colors.reset}`)
    process.exit(1)
  }
